...
| `tooltipProps`       | object   | -                                                                                                                      | `false`  | An object with props for the built-in tooltip component. Supports: `place` ('top', 'bottom', 'left', 'right'), `effect` ('solid', 'float'), `multiline` (boolean), `delayHide` (number), `delayShow` (number), `className`, `style`. |
